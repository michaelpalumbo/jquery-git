                            ...
                            .then(
                                ...
                                response.json().then(function(data) {
                                    ...
                                    for(i = 0; i < data.length; i++){
                                        ...
                                        html = '<br>Author: ' + data[i].commit.author.name + '<br>Date: ' + data[i].commit.author.date + '<br>Version notes: ' + data[i].commit.message + '<br>  <a class="jquery-git-repo-link" href="' +
                                        data[i].html_url + '" target="_blank">View Changes</div><br><a href="' + v.url + '/zipball/' + data[i].sha + '" target="_blank"><u><b>Download</u></b><p>'
                                        var $toProcess = $( html );
